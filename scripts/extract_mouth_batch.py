...
# SOURCE_PATH = '/home/cjk/PycharmProjects/dataset/video/s1'
SOURCE_EXTS = sys.argv[2]
# SOURCE_EXTS = '*.mpg'
TARGET_PATH = sys.argv[3]
# TARGET_PATH = '/home/cjk/PycharmProjects/dataset/video/target'

FACE_PREDICTOR_PATH = sys.argv[4]
# FACE_PREDICTOR_PATH = '/home/cjk/PycharmProjects/LipNet/common/predictors/shape_predictor_68_face_landmarks.dat'
...
for filepath in find_files(SOURCE_PATH, SOURCE_EXTS):
    ...
    target_dir = os.path.join(TARGET_PATH, filepath_wo_ext.split('/')[-1])
    mkdir_p(target_dir)
